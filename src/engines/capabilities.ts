...
export const ENGINE_CAPABILITIES = {
  ...
  'claude-cli': { transport: 'process', nativeLimit: 'native limits unverified', events: 'stream-json messages/tools/result; provider stream acceptance pending', unbounded: 'unverified', stop: 'transport cancellation; backend confirmation pending' },
  ...
  qwen: { transport: 'process', nativeLimit: 'native limits unverified', events: 'stream-json messages/tools/result; legacy JSON array supported', unbounded: 'unverified', stop: 'transport cancellation; backend confirmation pending' },
